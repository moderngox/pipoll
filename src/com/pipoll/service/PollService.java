					...
					try {
						...
						if (responseData != null) {
							...
							if (!application.isTopicAlreadyPresentToday(topic, formattedDate)) {
								...
								// Pollendpoint.Builder endpointBuilder = new
								// Pollendpoint.Builder(
								...
								// com.pipoll.entity.pollendpoint.model.Poll pollAE = new
								// com.pipoll.entity.pollendpoint.model.Poll();
